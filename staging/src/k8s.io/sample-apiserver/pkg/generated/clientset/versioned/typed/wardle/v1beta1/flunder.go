...
type flundersScoper struct {
	client *WardleV1beta1Client
	scope  rest.Scope
}

func newFlundersScoper(c *WardleV1beta1Client, scope rest.Scope) *flundersScoper {
...
func newFlunders(c *WardleV1beta1Client, scope rest.Scope, namespace string) *flunders {
	return &flunders{
		client: c.RESTClient(),
		scope:  scope,
		ns:     namespace,
