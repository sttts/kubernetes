...
type Webhook struct {
	...
	// Defaults to "Never".
	// +optional
	ReinvocationPolicy *ReinvocationPolicyType `json:"reinvocationPolicy,omitempty" protobuf:"bytes,9,opt,name=reinvocationPolicy,casttype=ReinvocationPolicyType"`
}
