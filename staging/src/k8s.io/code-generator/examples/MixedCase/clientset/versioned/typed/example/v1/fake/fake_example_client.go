...
func (c *FakeExampleV1) ScopedClusterTestTypes(scope rest.Scope) v1.ClusterTestTypeInterface {
...
func (c *FakeExampleV1) ScopedTestTypes(scope rest.Scope) v1.TestTypesGetter {
	panic("not implemented yet!")
}
