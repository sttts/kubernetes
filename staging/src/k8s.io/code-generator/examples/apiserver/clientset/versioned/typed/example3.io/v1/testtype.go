...
type testTypesScoper struct {
	client *ThirdExampleV1Client
	scope  rest.Scope
}

func newTestTypesScoper(c *ThirdExampleV1Client, scope rest.Scope) *testTypesScoper {
...
func newTestTypes(c *ThirdExampleV1Client, scope rest.Scope, namespace string) *testTypes {
	return &testTypes{
		client: c.RESTClient(),
		scope:  scope,
		ns:     namespace,
