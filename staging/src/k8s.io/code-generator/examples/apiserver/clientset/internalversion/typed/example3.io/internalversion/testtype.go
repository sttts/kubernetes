...
type testTypesScoper struct {
	client *ThirdExampleClient
	scope  rest.Scope
}

func newTestTypesScoper(c *ThirdExampleClient, scope rest.Scope) *testTypesScoper {
...
func newTestTypes(c *ThirdExampleClient, scope rest.Scope, namespace string) *testTypes {
	return &testTypes{
		client: c.RESTClient(),
		scope:  scope,
		ns:     namespace,
