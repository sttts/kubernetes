...
type testTypesScoper struct {
	client *SecondExampleV1Client
	scope  rest.Scope
}

func newTestTypesScoper(c *SecondExampleV1Client, scope rest.Scope) *testTypesScoper {
...
func newTestTypes(c *SecondExampleV1Client, scope rest.Scope, namespace string) *testTypes {
	return &testTypes{
		client: c.RESTClient(),
		scope:  scope,
		ns:     namespace,
