...
type PodDisruptionBudgetNamespaceLister interface {
	...
	// GetWithContext retrieves the PodDisruptionBudget from the index for a given name.
	// Objects returned here must be treated as read-only.
	GetWithContext(ctx context.Context, name string) (*v1beta1.PodDisruptionBudget, error)
