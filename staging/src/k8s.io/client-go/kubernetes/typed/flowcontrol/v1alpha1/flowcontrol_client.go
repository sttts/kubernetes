...
func (c *FlowcontrolV1alpha1Client) ScopedFlowSchemas(scope rest.Scope) FlowSchemaInterface {
...
func (c *FlowcontrolV1alpha1Client) ScopedPriorityLevelConfigurations(scope rest.Scope) PriorityLevelConfigurationInterface {
...
func NewForConfigAndClient(c *rest.Config, h rest.HTTPClient) (*FlowcontrolV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
...
// NewWithScope creates a new FlowcontrolV1alpha1Client for the given RESTClient and scope.
func NewWithScope(c rest.Interface, scope rest.Scope) *FlowcontrolV1alpha1Client {
	return &FlowcontrolV1alpha1Client{restClient: c, scope: scope}
}
