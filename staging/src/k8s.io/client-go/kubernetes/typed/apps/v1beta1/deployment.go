...
type ScopedDeploymentsGetter interface {
	ScopedDeployments(scope rest.Scope) DeploymentsGetter
}
...
type deploymentsScoper struct {
	client *AppsV1beta1Client
	scope  rest.Scope
}

func newDeploymentsScoper(c *AppsV1beta1Client, scope rest.Scope) *deploymentsScoper {
	return &deploymentsScoper{
		client: c,
		scope:  scope,
	}
}

func (s *deploymentsScoper) Deployments(namespace string) DeploymentInterface {
	return newDeployments(s.client, s.scope, namespace)
}
...
func newDeployments(c *AppsV1beta1Client, scope rest.Scope, namespace string) *deployments {
	return &deployments{
		client: c.RESTClient(),
		scope:  scope,
		ns:     namespace,
