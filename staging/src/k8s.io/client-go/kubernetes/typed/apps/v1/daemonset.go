...
func newDaemonSetsScoper(c *AppsV1Client, scope rest.Scope) *daemonSetsScoper {
...
func newDaemonSets(c *AppsV1Client, scope rest.Scope, namespace string) *daemonSets {
	return &daemonSets{
		client: c.RESTClient(),
		scope:  scope,
		ns:     namespace,
