...
func newDeploymentsScoper(c *AppsV1beta2Client, scope rest.Scope) *deploymentsScoper {
...
func newDeployments(c *AppsV1beta2Client, scope rest.Scope, namespace string) *deployments {
	return &deployments{
		client: c.RESTClient(),
		scope:  scope,
		ns:     namespace,
