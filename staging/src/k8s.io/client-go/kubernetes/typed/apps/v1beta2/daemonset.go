...
func newDaemonSetsScoper(c *AppsV1beta2Client, scope rest.Scope) *daemonSetsScoper {
...
func newDaemonSets(c *AppsV1beta2Client, scope rest.Scope, namespace string) *daemonSets {
	return &daemonSets{
		client: c.RESTClient(),
		scope:  scope,
		ns:     namespace,
