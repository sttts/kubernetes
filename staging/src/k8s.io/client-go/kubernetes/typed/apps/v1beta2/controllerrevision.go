...
func newControllerRevisionsScoper(c *AppsV1beta2Client, scope rest.Scope) *controllerRevisionsScoper {
...
func newControllerRevisions(c *AppsV1beta2Client, scope rest.Scope, namespace string) *controllerRevisions {
