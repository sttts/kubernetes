...
func (c *CoordinationV1beta1Client) ScopedLeases(scope rest.Scope) LeasesGetter {
...
func NewForConfigAndClient(c *rest.Config, h rest.HTTPClient) (*CoordinationV1beta1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
...
// NewWithScope creates a new CoordinationV1beta1Client for the given RESTClient and scope.
func NewWithScope(c rest.Interface, scope rest.Scope) *CoordinationV1beta1Client {
	return &CoordinationV1beta1Client{restClient: c, scope: scope}
}
