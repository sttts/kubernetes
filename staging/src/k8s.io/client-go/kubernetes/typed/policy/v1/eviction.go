...
func newEvictionsScoper(c *PolicyV1Client, scope rest.Scope) *evictionsScoper {
...
func newEvictions(c *PolicyV1Client, scope rest.Scope, namespace string) *evictions {
	return &evictions{
		client: c.RESTClient(),
		scope:  scope,
		ns:     namespace,
