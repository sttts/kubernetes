...
type horizontalPodAutoscalersScoper struct {
	client *AutoscalingV2beta2Client
	scope  rest.Scope
}

func newHorizontalPodAutoscalersScoper(c *AutoscalingV2beta2Client, scope rest.Scope) *horizontalPodAutoscalersScoper {
...
func newHorizontalPodAutoscalers(c *AutoscalingV2beta2Client, scope rest.Scope, namespace string) *horizontalPodAutoscalers {
