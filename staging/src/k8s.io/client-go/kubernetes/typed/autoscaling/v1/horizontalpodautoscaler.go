...
type horizontalPodAutoscalersScoper struct {
	client *AutoscalingV1Client
	scope  rest.Scope
}

func newHorizontalPodAutoscalersScoper(c *AutoscalingV1Client, scope rest.Scope) *horizontalPodAutoscalersScoper {
...
func newHorizontalPodAutoscalers(c *AutoscalingV1Client, scope rest.Scope, namespace string) *horizontalPodAutoscalers {
