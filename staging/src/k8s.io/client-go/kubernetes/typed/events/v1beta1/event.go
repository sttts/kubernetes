...
type ScopedEventsGetter interface {
	ScopedEvents(scope rest.Scope) EventsGetter
}
...
type eventsScoper struct {
	client *EventsV1beta1Client
	scope  rest.Scope
}

func newEventsScoper(c *EventsV1beta1Client, scope rest.Scope) *eventsScoper {
	return &eventsScoper{
		client: c,
		scope:  scope,
	}
...
func (s *eventsScoper) Events(namespace string) EventInterface {
	return newEvents(s.client, s.scope, namespace)
}
...
func newEvents(c *EventsV1beta1Client, scope rest.Scope, namespace string) *events {
	return &events{
		client: c.RESTClient(),
		scope:  scope,
		ns:     namespace,
