...
type ScopedVolumeAttachmentsGetter interface {
	ScopedVolumeAttachments(scope rest.Scope) VolumeAttachmentInterface
}
...
func newVolumeAttachments(c *StorageV1alpha1Client, scope rest.Scope) *volumeAttachments {
