...
type cSIStorageCapacitiesScoper struct {
	client *StorageV1beta1Client
	scope  rest.Scope
}

func newCSIStorageCapacitiesScoper(c *StorageV1beta1Client, scope rest.Scope) *cSIStorageCapacitiesScoper {
...
func newCSIStorageCapacities(c *StorageV1beta1Client, scope rest.Scope, namespace string) *cSIStorageCapacities {
