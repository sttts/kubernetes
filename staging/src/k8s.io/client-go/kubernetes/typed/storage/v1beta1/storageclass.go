...
type ScopedStorageClassesGetter interface {
	ScopedStorageClasses(scope rest.Scope) StorageClassInterface
}
...
func newStorageClasses(c *StorageV1beta1Client, scope rest.Scope) *storageClasses {
