...
type ScopedCSIDriversGetter interface {
	ScopedCSIDrivers(scope rest.Scope) CSIDriverInterface
}
...
func newCSIDrivers(c *StorageV1Client, scope rest.Scope) *cSIDrivers {
	return &cSIDrivers{
		client:  c.RESTClient(),
		cluster: c.cluster,
		scope:   scope,
