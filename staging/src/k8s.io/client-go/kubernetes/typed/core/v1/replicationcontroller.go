...
type ScopedReplicationControllersGetter interface {
	ScopedReplicationControllers(scope rest.Scope) ReplicationControllersGetter
}
...
type replicationControllersScoper struct {
	client *CoreV1Client
	scope  rest.Scope
}

func newReplicationControllersScoper(c *CoreV1Client, scope rest.Scope) *replicationControllersScoper {
	return &replicationControllersScoper{
		client: c,
		scope:  scope,
	}
}

func (s *replicationControllersScoper) ReplicationControllers(namespace string) ReplicationControllerInterface {
	return newReplicationControllers(s.client, s.scope, namespace)
}
