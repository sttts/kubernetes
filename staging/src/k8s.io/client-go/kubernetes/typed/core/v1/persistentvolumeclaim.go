...
type ScopedPersistentVolumeClaimsGetter interface {
	ScopedPersistentVolumeClaims(scope rest.Scope) PersistentVolumeClaimsGetter
}
...
type persistentVolumeClaimsScoper struct {
	client *CoreV1Client
	scope  rest.Scope
}

func newPersistentVolumeClaimsScoper(c *CoreV1Client, scope rest.Scope) *persistentVolumeClaimsScoper {
	return &persistentVolumeClaimsScoper{
		client: c,
		scope:  scope,
	}
}

func (s *persistentVolumeClaimsScoper) PersistentVolumeClaims(namespace string) PersistentVolumeClaimInterface {
	return newPersistentVolumeClaims(s.client, s.scope, namespace)
}
...
func newPersistentVolumeClaims(c *CoreV1Client, scope rest.Scope, namespace string) *persistentVolumeClaims {
