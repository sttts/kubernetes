...
type localSubjectAccessReviewsScoper struct {
	client *AuthorizationV1beta1Client
	scope  rest.Scope
}

func newLocalSubjectAccessReviewsScoper(c *AuthorizationV1beta1Client, scope rest.Scope) *localSubjectAccessReviewsScoper {
