...
type roleBindingsScoper struct {
	client *RbacV1beta1Client
	scope  rest.Scope
}

func newRoleBindingsScoper(c *RbacV1beta1Client, scope rest.Scope) *roleBindingsScoper {
...
func newRoleBindings(c *RbacV1beta1Client, scope rest.Scope, namespace string) *roleBindings {
	return &roleBindings{
		client: c.RESTClient(),
		scope:  scope,
		ns:     namespace,
