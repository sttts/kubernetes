...
func (c *RbacV1alpha1Client) ScopedClusterRoles(scope rest.Scope) ClusterRoleInterface {
...
func (c *RbacV1alpha1Client) ScopedClusterRoleBindings(scope rest.Scope) ClusterRoleBindingInterface {
...
func (c *RbacV1alpha1Client) ScopedRoles(scope rest.Scope) RolesGetter {
...
func (c *RbacV1alpha1Client) ScopedRoleBindings(scope rest.Scope) RoleBindingsGetter {
...
func NewForConfigAndClient(c *rest.Config, h rest.HTTPClient) (*RbacV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
...
// NewWithScope creates a new RbacV1alpha1Client for the given RESTClient and scope.
func NewWithScope(c rest.Interface, scope rest.Scope) *RbacV1alpha1Client {
	return &RbacV1alpha1Client{restClient: c, scope: scope}
}
