...
func (c *RbacV1alpha1Client) ScopedRoles(scope rest.Scope, namespace string) RoleInterface {
...
func (c *RbacV1alpha1Client) ScopedRoleBindings(scope rest.Scope, namespace string) RoleBindingInterface {
