...
func (c *SchedulingV1alpha1Client) PriorityClasses() PriorityClassInterface {
	return newPriorityClasses(c, c.scope)
}

func (c *SchedulingV1alpha1Client) ScopedPriorityClasses(scope rest.Scope) PriorityClassInterface {
...
func NewForConfigAndClient(c *rest.Config, h rest.HTTPClient) (*SchedulingV1alpha1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
...
// NewWithScope creates a new SchedulingV1alpha1Client for the given RESTClient and scope.
func NewWithScope(c rest.Interface, scope rest.Scope) *SchedulingV1alpha1Client {
	return &SchedulingV1alpha1Client{restClient: c, scope: scope}
}
