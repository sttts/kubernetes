...
// NewWithScope creates a new SchedulingV1Client for the given RESTClient and scope.
func NewWithScope(c rest.Interface, scope rest.Scope) *SchedulingV1Client {
	return &SchedulingV1Client{restClient: c, scope: scope}
}
