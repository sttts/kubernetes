...
func newNetworkPoliciesScoper(c *NetworkingV1Client, scope rest.Scope) *networkPoliciesScoper {
...
func newNetworkPolicies(c *NetworkingV1Client, scope rest.Scope, namespace string) *networkPolicies {
