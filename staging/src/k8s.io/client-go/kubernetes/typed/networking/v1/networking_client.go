...
func (c *NetworkingV1Client) ScopedIngresses(scope rest.Scope, namespace string) IngressInterface {
...
func (c *NetworkingV1Client) ScopedNetworkPolicies(scope rest.Scope, namespace string) NetworkPolicyInterface {
