...
func newIngressesScoper(c *NetworkingV1beta1Client, scope rest.Scope) *ingressesScoper {
...
func newIngresses(c *NetworkingV1beta1Client, scope rest.Scope, namespace string) *ingresses {
	return &ingresses{
		client: c.RESTClient(),
		scope:  scope,
		ns:     namespace,
