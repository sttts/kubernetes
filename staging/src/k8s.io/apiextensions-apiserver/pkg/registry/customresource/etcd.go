...
func NewStorage(resource schema.GroupResource, listKind schema.GroupVersionKind, strategy customResourceStrategy, optsGetter generic.RESTOptionsGetter, status *apiextensions.CustomResourceSubResourceStatus, scale *apiextensions.CustomResourceSubResourceScale) CustomResourceStorage {
...
func (r *ScaleREST) GroupVersionKind(containingGV schema.GroupVersion) schema.GroupVersionKind {
	return autoscalingv1.SchemeGroupVersion.WithKind("Scale") // TODO: to plumb specified external type
}
