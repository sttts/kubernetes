...
func (c *customResourceDefinitionsClusterClient) List(ctx context.Context, opts metav1.ListOptions) (*apiextensionsv1beta1.CustomResourceDefinitionList, error) {
	obj, err := c.Fake.Invokes(kcptesting.NewRootListAction(customResourceDefinitionsResource, customResourceDefinitionsKind, logicalcluster.WildcardPath, opts), &apiextensionsv1beta1.CustomResourceDefinitionList{})
	if obj == nil {
		return nil, err
	}
