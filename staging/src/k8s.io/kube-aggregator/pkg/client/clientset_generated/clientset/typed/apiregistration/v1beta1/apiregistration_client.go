...
func NewForConfigAndClient(c *rest.Config, h rest.HTTPClient) (*ApiregistrationV1beta1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
...
// NewWithScope creates a new ApiregistrationV1beta1Client for the given RESTClient and scope.
func NewWithScope(c rest.Interface, scope rest.Scope) *ApiregistrationV1beta1Client {
	return &ApiregistrationV1beta1Client{restClient: c, scope: scope}
}
