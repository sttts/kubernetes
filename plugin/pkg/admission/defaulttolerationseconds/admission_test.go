...
func TestForgivenessAdmission(t *testing.T) {
	...
	for _, test := range tests {
		err := handler.MutatingAdmit(admission.NewAttributesRecord(&test.requestedPod, nil, api.Kind("Pod").WithVersion("version"), "foo", "name", api.Resource("pods").WithVersion("version"), "", "ignored", nil))
		if err != nil {
