...
func TestAdmissionNonNilAttribute(t *testing.T) {
	...
	err := handler.MutatingAdmit(admission.NewAttributesRecord(nil, nil, api.Kind("kind").WithVersion("version"), "namespace", "name", api.Resource("resource").WithVersion("version"), "subresource", admission.Create, nil))
	if err != nil {
