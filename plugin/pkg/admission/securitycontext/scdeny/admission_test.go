...
func TestAdmission(t *testing.T) {
	...
	for _, tc := range cases {
		...
		err := handler.MutatingAdmit(admission.NewAttributesRecord(p, nil, api.Kind("Pod").WithVersion("version"), "foo", "name", api.Resource("pods").WithVersion("version"), "", "ignored", nil))
