...
import (
	...
	v1 "github.com/kcp-dev/client-go/kubernetes/typed/core/v1"
...
type Config struct {
	...
	SecretsWriter               v1.SecretClusterInterface
...
func newLegacyServiceAccountAuthenticator(keyfiles []string, lookup bool, apiAudiences authenticator.Audiences, serviceAccountGetter serviceaccount.ServiceAccountTokenClusterGetter, secretsWriter v1.SecretClusterInterface) (authenticator.Token, error) {
