...
require (
	...
	github.com/openshift/apiserver-library-go v0.0.0-20200716071236-6da3ffdf4bde
...
replace (
	...
	github.com/openshift/library-go => github.com/openshift/library-go v0.0.0-20200715184320-4db371767180
