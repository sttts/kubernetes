...
func (c *mutatingWebhookConfigurationsClusterInterface) Cluster(name logicalcluster.Path) admissionregistrationv1beta1client.MutatingWebhookConfigurationInterface {
