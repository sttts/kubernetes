...
func (c *mutatingWebhookConfigurationsClusterInterface) Cluster(path logicalcluster.Path) admissionregistrationv1beta1client.MutatingWebhookConfigurationInterface {
