...
import (
	...
	nodev1alpha1client "k8s.io/client-go/kubernetes/typed/node/v1alpha1"
)
...
type runtimeClassesClusterInterface struct {
	clientCache kcpclient.Cache[*nodev1alpha1client.NodeV1alpha1Client]
}

// Cluster scopes the client down to a particular cluster.
func (c *runtimeClassesClusterInterface) Cluster(path logicalcluster.Path) nodev1alpha1client.RuntimeClassInterface {
...
func (c *runtimeClassesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*nodev1alpha1.RuntimeClassList, error) {
