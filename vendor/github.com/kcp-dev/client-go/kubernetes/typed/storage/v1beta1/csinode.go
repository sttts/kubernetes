...
// or scope down to one cluster and return a storagev1beta1client.CSINodeInterface.
type CSINodeClusterInterface interface {
	Cluster(logicalcluster.Path) storagev1beta1client.CSINodeInterface
	List(ctx context.Context, opts metav1.ListOptions) (*storagev1beta1.CSINodeList, error)
...
func (c *cSINodesClusterInterface) Cluster(path logicalcluster.Path) storagev1beta1client.CSINodeInterface {
...
func (c *cSINodesClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*storagev1beta1.CSINodeList, error) {
