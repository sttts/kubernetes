...
func (c *replicaSetsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*appsv1.ReplicaSetList, error) {
...
type ReplicaSetsNamespacer interface {
	Namespace(string) appsv1client.ReplicaSetInterface
}
