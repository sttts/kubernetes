...
func (c *eventsClusterInterface) List(ctx context.Context, opts metav1.ListOptions) (*eventsv1beta1.EventList, error) {
...
// EventsNamespacer can scope to objects within a namespace, returning a eventsv1beta1client.EventInterface.
type EventsNamespacer interface {
	Namespace(string) eventsv1beta1client.EventInterface
}
