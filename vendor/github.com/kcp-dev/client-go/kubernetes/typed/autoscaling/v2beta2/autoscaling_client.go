...
type AutoscalingV2beta2ClusterInterface interface {
...
func (c *AutoscalingV2beta2ClusterClient) Cluster(path logicalcluster.Path) autoscalingv2beta2.AutoscalingV2beta2Interface {
...
// NewForConfig creates a new AutoscalingV2beta2ClusterClient for the given config.
// NewForConfig is equivalent to NewForConfigAndClient(c, httpClient),
// where httpClient was generated with rest.HTTPClientFor(c).
func NewForConfig(c *rest.Config) (*AutoscalingV2beta2ClusterClient, error) {
...
// NewForConfigAndClient creates a new AutoscalingV2beta2ClusterClient for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*AutoscalingV2beta2ClusterClient, error) {
...
// NewForConfigOrDie creates a new AutoscalingV2beta2ClusterClient for the given config and
// panics if there is an error in the config.
func NewForConfigOrDie(c *rest.Config) *AutoscalingV2beta2ClusterClient {
