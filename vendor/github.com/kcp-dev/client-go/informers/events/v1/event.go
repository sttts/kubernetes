...
import (
	...
	upstreameventsv1listers "k8s.io/client-go/listers/events/v1"
	"k8s.io/client-go/tools/cache"

	"github.com/kcp-dev/client-go/informers/internalinterfaces"
	clientset "github.com/kcp-dev/client-go/kubernetes"
	eventsv1listers "github.com/kcp-dev/client-go/listers/events/v1"
)
...
type EventClusterInformer interface {
	...
	Lister() eventsv1listers.EventClusterLister
}
	...
	return kcpinformers.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.EventsV1().Events().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.EventsV1().Events().Watch(context.TODO(), options)
			},
		},
		&eventsv1.Event{},
		resyncPeriod,
...
func (f *eventClusterInformer) Lister() eventsv1listers.EventClusterLister {
	return eventsv1listers.NewEventClusterLister(f.Informer().GetIndexer())
}

func (f *eventClusterInformer) Cluster(cluster logicalcluster.Name) upstreameventsv1informers.EventInformer {
...
type eventInformer struct {
	...
	lister   upstreameventsv1listers.EventLister
}
...
func (f *eventInformer) Lister() upstreameventsv1listers.EventLister {
	return f.lister
}
