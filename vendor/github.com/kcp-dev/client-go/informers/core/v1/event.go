...
func (f *eventClusterInformer) Lister() corev1listers.EventClusterLister {
	return corev1listers.NewEventClusterLister(f.Informer().GetIndexer())
}

func (f *eventClusterInformer) Cluster(cluster logicalcluster.Name) upstreamcorev1informers.EventInformer {
...
type eventInformer struct {
	...
	lister   upstreamcorev1listers.EventLister
}
...
func (f *eventInformer) Lister() upstreamcorev1listers.EventLister {
	return f.lister
}
