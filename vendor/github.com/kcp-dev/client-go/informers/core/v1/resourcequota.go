...
func (f *resourceQuotaClusterInformer) Cluster(cluster logicalcluster.Name) upstreamcorev1informers.ResourceQuotaInformer {
...
type resourceQuotaInformer struct {
	...
	lister   upstreamcorev1listers.ResourceQuotaLister
}
...
func (f *resourceQuotaInformer) Lister() upstreamcorev1listers.ResourceQuotaLister {
	return f.lister
}
