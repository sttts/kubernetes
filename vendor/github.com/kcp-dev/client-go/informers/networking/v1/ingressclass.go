...
type IngressClassClusterInformer interface {
	...
	Lister() networkingv1listers.IngressClassClusterLister
}
...
func (f *ingressClassClusterInformer) Lister() networkingv1listers.IngressClassClusterLister {
	return networkingv1listers.NewIngressClassClusterLister(f.Informer().GetIndexer())
}

func (f *ingressClassClusterInformer) Cluster(cluster logicalcluster.Name) upstreamnetworkingv1informers.IngressClassInformer {
...
type ingressClassInformer struct {
	...
	lister   upstreamnetworkingv1listers.IngressClassLister
}
...
func (f *ingressClassInformer) Lister() upstreamnetworkingv1listers.IngressClassLister {
	return f.lister
}
