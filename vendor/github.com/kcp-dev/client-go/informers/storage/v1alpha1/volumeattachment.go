...
func (f *volumeAttachmentClusterInformer) Cluster(cluster logicalcluster.Name) upstreamstoragev1alpha1informers.VolumeAttachmentInformer {
...
type volumeAttachmentInformer struct {
	...
	lister   upstreamstoragev1alpha1listers.VolumeAttachmentLister
}
...
func (f *volumeAttachmentInformer) Lister() upstreamstoragev1alpha1listers.VolumeAttachmentLister {
	return f.lister
}
